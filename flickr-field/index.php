			...
			<section id="content">
				<div class="content_wrap">
					...
					<div class="clearfix">
						...
						<div class="right">
							<a href="flickr_field.zip" onClick="javascript: _gaq.push(['_trackPageview', '/downloads/flickr-field']);">
								<div class="flickr-field-content download">
									<h2 class="dinot-font no-border">Download</h2>
									<a href="flickr_field.zip" onClick="javascript: _gaq.push(['_trackPageview', '/downloads/flickr-field']);">Download the Flickr field &rarr;</a>
								</div>
							</a>
						</div>
